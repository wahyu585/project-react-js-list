...
class Pegawai extends Component{
    ...
    edit = (item) =>{
        $("#modal").show()
        /* - mengisikan isi variabel nip, nama, 
        alamat sesuai dengan data yang akan diedit
    ...
    render(){
        return(
            <div className="m-3 card">
                <div className="card-header bg-infp text-yellow">DATA PEGAWAI</div>
                <div className="card-body">
                    <input type="text"className="form-control mb-2"name="seacrh"value={this.state.seacrh}
